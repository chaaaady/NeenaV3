...
export default function StepAmountV13Page() {
  ...
  useEffect(() => {
    const themeColor = "#457ba7"; // Blue matching video + overlays for iOS notch and gesture bar
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#457ba7" }}>
      ...
      >
        ...
        <video
          ...
          ref={(video) => {
            if (video) {
              video.playbackRate = 0.9; // Ralentir à 90% de la vitesse normale
            }
          }}
        >
            ...
            <section className="w-full space-y-5">
              ...
              <div className="rounded-3xl border border-white/20 bg-gradient-to-br from-white/[0.20] via-white/[0.15] to-white/[0.10] backdrop-blur-xl shadow-2xl p-6 md:p-7">
                <div className="space-y-4">
                  <div>
                    <label className="block text-white/80 text-[13px] font-medium mb-2">Fréquence</label>
                    <GlassSegmented
                  ...
                  <div>
                    <label className="block text-white/80 text-[13px] font-medium mb-2">Type de don</label>
                    <GlassSegmented
