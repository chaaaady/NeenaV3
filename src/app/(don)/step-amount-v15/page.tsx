...
export default function StepAmountV15Page() {
                  ...
                  <div className="w-full rounded-2xl bg-white/10 p-4">
                    ...
                    <div className="mt-4">
                      <div className="relative">
                        ...
                        />
                        {otherAmountInput && (
                          <span className="absolute right-4 top-1/2 -translate-y-1/2 text-white text-[16px] font-medium pointer-events-none">
                            €
                          </span>
                        )}
                      </div>
                  ...
                  {!canShowPayment ? (
                    <div className="text-center py-8">
                      <p className="text-white/70 text-[15px] leading-relaxed">
                        Veuillez remplir toutes les informations pour continuer vers le paiement.
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      ...
                      <div className="rounded-2xl bg-white/10 border border-white/10 p-4 space-y-3">
                        ...
                        <div className="flex flex-col items-center justify-center text-white pt-3">
                          ...
                          <div className="text-white/70 text-[13px] mt-1">
                            {values.frequency === "Unique" ? "Don unique" : values.frequency === "Vendredi" ? "Chaque vendredi" : "Chaque mois"}
                          </div>
                        </div>
                      </div>
                      ...
                      {stripeError && (
                        <div className="p-4 rounded-2xl bg-red-500/10 border border-red-500/20">
                          <p className="text-red-200 text-[14px] leading-relaxed text-center">
                            {stripeError}
                          </p>
                        </div>
                      )}
